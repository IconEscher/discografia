...
<ul>
  <img src="${pageContext.request.contextPath}/resources/image/dtlogo.jpg" class="d-block w-60" alt="...">
  <ol>Biografia</ol>
  <ol><a href="https://dreamtheater.net/discography/">Discografia</a></ol>
  <br>
  <br>
  <img src="${pageContext.request.contextPath}/resources/image/Led-Zeppelin.png" class="d-block w-20" alt="...">
  <ol><a href="https://it.wikipedia.org/wiki/Led_Zeppelin">Biografia</a></ol>
  <ol><a href="https://dreamtheater.net/discography/">Discografia</a></ol>
  <br>
  <br>
  <img src="${pageContext.request.contextPath}/resources/image/queenlogo1.png" class="d-block w-20" alt="...">
</ul>
<!--[if lt IE 7]>
